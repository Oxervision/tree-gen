...
class Tree(object):
    ...
    def __init__(self, param, generate_leaves=True, generate_armature=False):
        """initialize tree with specified parameters"""
        self.param = param
        self.generate_leaves = generate_leaves
        self.generate_armature = generate_armature
        self.leaves_array = []
        self.stem_index = 0
...
#     def create_armature(self, armAnim, leafP, cu, frameRate, leafMesh, leafObj, leafVertSize, leaves, levelCount, splineToBone,
